...
public class Cinema {
    ...
    public boolean add(String название, int год_производства, String жанр,
                       String адрес, int время_показа, int бюджет){
        ...
        if(название == null || год_производства <= 0 || жанр == null
                || адрес == null || время_показа <= 0 || бюджет <= 0){ return false; }
    ...
    public void printAll(){
        ...
        for(Movie temp : this.array){
            ...
            System.out.println("Фильм #" + ++count +
                    ...
                    "\nЖанр: " + temp.getGenre() +
                    "\nГод выпуска: " + temp.getProductionYear() +
                    "\nВремя показа: " + temp.getDuration() + "минут" +
                    "\nАдрес: " + temp.getAddress() +
    ...
    private class Movie {
        ...
        private int бюджет;
        private Movie(String название, int год_производства, String жанр,
                      String адрес, int время_показа, int бюджет) {
